      ...
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <div className="h-1/2 lg:h-full lg:w-1/2  flex flex-col gap-8 justify-center items-center">
          ...
          <div className="w-full flex gap-4">
            <button className="bg-black text-white p-5 rounded-lg ring-1 ring-white">View My Work</button>
            <button className="bg-white text-black p-5 rounded-lg ring-1 ring-black">Contact Me</button>
          </div>
        </div>
      </div>
    </motion.div>
