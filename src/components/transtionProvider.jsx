...
const TranstionProvider = ({ children }) => {
    ...
    return (
        <AnimatePresence mode="wait">
            <div key={pathName} className="w-screen h-screen bg-gradient-to-b from-blue-50 to-red-100">
                ...
                />
                <motion.div className="m-auto fixed top-0 bottom-0 left-0 right-0 text-white text-8xl cursor-default z-50 w-fit h-fit"
                    inital={{  opacity:1 }}
                    animate={{  opacity:0 }}
                    exit={{  opacity:0 }}
...
export default TranstionProvider